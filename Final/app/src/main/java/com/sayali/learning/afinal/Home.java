...
RecyclerView recyclerView;
    ...
    FirebaseRecyclerAdapter<Category,MyHolder> adapter;
   /* public Home(FireBaseClient fireBaseClient) {
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCategory = database.getReference("Category");
...
loadMenu();
    ...
    private void loadMenu() {
        adapter=new FirebaseRecyclerAdapter<Category, MyHolder>(Category.class,R.layout.menu_item,MyHolder.class,mCategory) {
            @Override
            protected void populateViewHolder(MyHolder viewHolder, Category model, int position) {
                viewHolder.nameTxt.setText(model.getName());
                //viewHolder.nameTxt.setText(""+model.getName());

                Picasso.with(getBaseContext()).load(model.getUrl()).into(viewHolder.img);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            ...
            sign.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK |Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(sign);
